...
@Component({
  selector: 'app-more-properties-card',
  templateUrl: './more-properties-card.component.html',
  styleUrls: ['./more-properties-card.component.css']
})
export class MorePropertiesCardComponent {
